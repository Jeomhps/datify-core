...
- **Locale data fixes** (wrong or missing translations) should go upstream to [CLDR](https://cldr.unicode.org/); corrections then flow in automatically on the next data update.
